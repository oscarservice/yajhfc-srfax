...
public class ServerOptions extends IDAndNameOptions {
    ...
    /**
     * The SRFax Sender's Email Address
     */
    public String SRFaxEmail = "";
    
    /**
     * The SRFax Sender's Fax Number (must be 10 digits)
     */
    public String SRFaxNumber = "";
    
    /**
     * Display faxes from last __ days
     */
    public int SRFaxDayRange = 30;
    
    /**
     * Display read faxes
     */
    public boolean SRFaxShowRead = true;
    
    /**
     * Display unread faxes
     */
    public boolean SRFaxShowUnread = true;
    
    /**
     * Display faxes received by a sub user of the account as well
     */
    public boolean SRFaxIncludeSubUsers = false;
